		<#macro macroPanel idh editor >
		 <#-- final JFormattedTextField ${idh} =new JFormattedTextField(); 
		 final EditorBigDecimal ${idh} = new EditorBigDecimal();
		
		  ${idh}.setOpaque(true);
		  ${idh}.setFont(RunnerLF.getFont("EditorDouble.font"));
		 ${idh}.setFocusLostBehavior(JFormattedTextField.COMMIT_OR_REVERT);-->
		 <#assign enteros="-1">
		 <#assign decimales="-1">
		 <#assign locale="ES">
		 <#assign pos ="-1">
		...
		${idh}.setClaseEditor("lightswingrunner.editors.EditorBigDecimal");
